...
GLint State::cull_mode_map_[] = {GL_FRONT, GL_BACK};

GLint State::blending_factor_map_[] = {GL_ZERO,
                                       GL_ONE,
                                       GL_SRC_COLOR,
...
State::State(const render::State& state)
    : blend_equation_rgb(blending_function_map_[static_cast<size_t>(
          state.blend_equation_rgb)]),
      blend_equation_alpha(blending_function_map_[static_cast<size_t>(
          state.blend_equation_alpha)]),
      blend_source_alpha(
          blending_factor_map_[static_cast<size_t>(state.blend_source_alpha)]),
      blend_source_rgb(
          blending_factor_map_[static_cast<size_t>(state.blend_source_rgb)]),
      blend_destination_alpha(blending_factor_map_[static_cast<size_t>(
          state.blend_destination_alpha)]),
      blend_destination_rgb(blending_factor_map_[static_cast<size_t>(
          state.blend_destination_rgb)]),
