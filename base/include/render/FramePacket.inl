...
std::array<FramePacket<Allocator>*, 2> FramePacket<Allocator>::frame_packets = {
    nullptr, nullptr};
...
template <template <typename> class Allocator>
const typename FramePacket<Allocator>::template Vector<MeshNode>&
FramePacket<Allocator>::get_mesh_nodes() const {
  return mesh_nodes_;
}
...
template <template <typename> class Allocator>
const typename FramePacket<Allocator>::template Vector<DirectionalLightNode>&
FramePacket<Allocator>::get_directional_light_nodes() const {
  return directional_light_nodes_;
}

template <template <typename> class Allocator>
typename FramePacket<Allocator>::template Vector<MeshNode>&
FramePacket<Allocator>::get_mesh_nodes() {
  return mesh_nodes_;
}

template <template <typename> class Allocator>
typename FramePacket<Allocator>::template Vector<DirectionalLightNode>&
FramePacket<Allocator>::get_directional_light_nodes() {
  return directional_light_nodes_;
}
